...
- Updated `@furystack/eslint-plugin` from ^2.0.0 to ^2.1.0
- Updated `@types/node` from ^25.3.5 to ^25.4.0
- Updated `lint-staged` from ^16.3.2 to ^16.3.3
- Updated `typescript-eslint` from ^8.56.1 to ^8.57.0
