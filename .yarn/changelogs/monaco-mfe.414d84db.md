...
- Fixed `registerSchema` to replace existing schemas with the same name instead of accumulating duplicates, preventing stale JSON validation rules in the Monaco editor
